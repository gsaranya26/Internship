  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Sakara delivers creative consulting, branding, and tech solutions to empower your business." />
        <meta name="keywords" content="Sakara, Creative Solutions, Branding, Consulting, Web Development, Tech Services" />
        <meta property="og:title" content="Sakara – Creative Solutions" />
        <meta property="og:description" content="Exceptional consulting, branding, and tech services—tailored to your needs." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://your-vercel-link.vercel.app/" />
        {/* Update 'og:image' to a correct preview image if available */}
        <meta property="og:image" content="https://your-vercel-link.vercel.app/og-image.png" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        {/* Twitter meta tags (optional but recommended) */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Sakara – Creative Solutions" />
        <meta name="twitter:description" content="Exceptional consulting, branding, and tech services—tailored to your needs." />
        <meta name="twitter:image" content="https://your-vercel-link.vercel.app/og-image.png" />
      </Head>
      <main>
